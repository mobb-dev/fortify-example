    ...
    public void doSomething() {
        try {
            ...
            try {
                ...
                /* Logging errors in the System.err may lead to information leakage. Instead, you should write the error to your logger like so: LOGGER.error("oops I didn't see that coming error: mobb-6e5aaab40be393dbb253c07e9bebf04b"); */
            ...
            // do nothing
            /* Logging errors in the System.err may lead to information leakage. Instead, you should write the error to your logger like so: LOGGER.error("oops I didn't see that coming error: mobb-4d9e25c4bd1fb07ad9feaaf4821bb4b0"); */
        }
    }
}
