...
public class noLogger {
    ...
    public void doSomething() {
        ...
        } catch (IOException io) {      /* Logging errors in the System.err may lead to information leakage. Instead, you should write the error to your logger like so: LOGGER.error("oops here is an error: mobb-6c438fb81308e628de0ea6703d090832"); */}
        catch (Exception e) {
            // do nothing
            /* Logging errors in the System.err may lead to information leakage. Instead, you should write the error to your logger like so: LOGGER.error("oops here is an error: mobb-4d9e25c4bd1fb07ad9feaaf4821bb4b0"); */
        }
    }
}
